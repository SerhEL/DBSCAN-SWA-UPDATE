...
def diamond_blastp(file,outfile,database,format,evalue,diamond_thread_num=20,min_identity=90):
...
def get_phage_like_gene(bac_protein_file,phage_gene_annotation_dir,prefix,diamond_thread_num,MIN_IDN):
...
if __name__=='__main__':
	...
	parser.add_argument('--min_idn',help='''Минимальный % идентичности для DIAMOND, default: 90\n''')
	...
	global ATT_MIN_IDN
	if args.min_idn:
		ATT_MIN_IDN = args.min_idn
	else:
		print('--min_idn По умолчанию: 50')
		ATT_MIN_IDN = 50
